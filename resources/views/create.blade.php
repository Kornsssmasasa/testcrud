    ...
    <div class="container mt-3">
        ...
        <div class="card mt-3" >
            <div class="card-body">
                ...
                <form class="mt-3" action="{{ route('person.saveinfor') }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tel" class="form-control" placeholder="telephone number">
                    </div>
                    <div class="mb-3">
